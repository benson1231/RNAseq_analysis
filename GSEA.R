...
gse_LCD <- gsea_run(data_path = data_path,
                   file="ip_Y_V_S_LCD_0_deg.xlsx", all_gene = T)
gse_HCD <- gsea_run(data_path = data_path,
                   file="ip_Y_V_S_HCD_0_deg.xlsx", all_gene = T)
gse_BAP <- gsea_run(data_path = data_path,
                   file="ip_Y_V_S_BAP_0_deg.xlsx", all_gene = T)
gse_AS_BAP <- gsea_run(data_path = data_path,
                   file="ip_Y_V_S_AS_BAP_0_deg.xlsx", all_gene = T)
gse_CO_BAP <- gsea_run(data_path = data_path,
                   file="ip_Y_V_S_CO_BAP_0_deg.xlsx", all_gene = T)
gse_LCD_BAP <- gsea_run(data_path = data_path,
                   file="ip_Y_V_S_LCD_BAP_0_deg.xlsx", all_gene = T)
gse_HCD_BAP <- gsea_run(data_path = data_path,
...
keg <- kegg_run(data_path = data_path,
                   file="ip_Y_V_S_CO_0_deg.xlsx", all_gene = T)
keg_LCD <- kegg_run(data_path = data_path,
                    file="ip_Y_V_S_LCD_0_deg.xlsx", all_gene = T)
keg_HCD <- kegg_run(data_path = data_path,
                    file="ip_Y_V_S_HCD_0_deg.xlsx", all_gene = T)
keg_BAP <- kegg_run(data_path = data_path,
                    file="ip_Y_V_S_BAP_0_deg.xlsx", all_gene = T)
keg_AS_BAP <- kegg_run(data_path = data_path,
                       file="ip_Y_V_S_AS_BAP_0_deg.xlsx", all_gene = T)
keg_CO_BAP <- kegg_run(data_path = data_path,
                       file="ip_Y_V_S_CO_BAP_0_deg.xlsx", all_gene = T)
keg_LCD_BAP <- kegg_run(data_path = data_path,
                        file="ip_Y_V_S_LCD_BAP_0_deg.xlsx", all_gene = T)
keg_HCD_BAP <- kegg_run(data_path = data_path,
                        file="ip_Y_V_S_HCD_BAP_0_deg.xlsx", all_gene = T)
...
### old code block --------------------------------------------------------
# run GSEA 
df <- readxl::read_xlsx(file.path(data_path, "ip_Y_V_S_AS_0_deg.xlsx"))
...
# circular form
cnetplot(net, color.params = list(foldChange = gse_AS@geneList, edge = TRUE), circular = TRUE) 
